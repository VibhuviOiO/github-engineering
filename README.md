...
|---|---|---|---|
| `ldap-manager` | `GITHUB_TOKEN` (auto) | `DOCKERHUB_USERNAME`, `DOCKERHUB_TOKEN` | `QUAY_USERNAME`, `QUAY_TOKEN` |
| `openldap-docker` | `GITHUB_TOKEN` (auto) | `DOCKERHUB_USERNAME`, `DOCKERHUB_TOKEN` | `QUAY_USERNAME`, `QUAY_TOKEN` |